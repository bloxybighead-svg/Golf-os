...
import { CLUB_WORK_CLUBS, type ClubWorkEntry } from "@/lib/supabase/types"
...
function emptyEntry(): ClubWorkEntry {
  return { club: CLUB_WORK_CLUBS[0], shots: null, avg_carry: null, dispersion: null, spin_var: null, notes: null }
}
    ...
    <div className="space-y-3">
      {entries.map((e, i) => (
        <div key={i} className="rounded-lg border border-[#2a2a2a] bg-[#161616] p-3">
          ...
          <input
            type="text"
            placeholder="Notes (e.g. working on 3/4 swing feel)"
            value={e.notes ?? ""}
