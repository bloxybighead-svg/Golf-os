...
const EMPTY_BLOCK: SessionBlock = {
  block_type: "Full Swing",
...
export function BlockForm({ drills, onSave, onCancel }: Props) {
  const [form, setForm] = useState<SessionBlock>(EMPTY_BLOCK)
    ...
    <div className="fixed inset-0 z-50 flex flex-col bg-[#0f0f0f]">
      ...
      <div className="flex-1 overflow-y-auto px-4 py-5 space-y-6">
        ...
        <div>
          ...
          <ClubPicker value={form.clubs_used} onChange={(v) => set("clubs_used", v)} />
        </div>

        {/* Shot count + Distance range */}
